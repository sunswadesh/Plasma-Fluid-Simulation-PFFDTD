...
// ./a.out dipole dipole90 0.438e6 0.1 1.16e6 90 0

double FREQ_PLASMA = 5e6; //0.438e6;			// Plasma Freuicy (Hz)
double FREQ_COL = 0.2;		                // Frequency of collision (% of fp)
double FREQ_CYC = 1e6;		// Cyclotron Frequency (Hz)
