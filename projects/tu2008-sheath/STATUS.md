...
| 2 — Oscillating boundary | **Active** | Sparse \(f\) done (out-of-bracket 3/3); phase scan next — `SCIENCE.md` §5 |
...
2. Paper 2: phase scan + harmonics next; then matched soft \(\Delta r\) per `SCIENCE.md` §5
