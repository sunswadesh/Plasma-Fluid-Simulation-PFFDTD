...
///////////////////////////////////////////////////
// Plasma.h modified to represent a sheath around a dipole. By varying the sheath width(Sd) parameter the thickness of the sheath can be controlled. The dipole geometry is derived from the .str files.
// Note that the thickness is measured by number of cells multiplied by the size of dx,dy,dz
//////////////////////////////////////////////////
...
void PLASMAclear()
{
  ...
  N_00[0] = 4*PI*PI*FREQ_PLASMA*FREQ_PLASMA*ME*EPSILON_0/QE/QE;
